...
read_GO_data <- function(go_res_file){
...
t12_go_res <- read_GO_data("results/r/tables/t12_GO_results.tsv")
t24_go_res <- read_GO_data("results/r/tables/t24_GO_results.tsv")
