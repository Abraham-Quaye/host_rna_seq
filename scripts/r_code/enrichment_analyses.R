...
plts <- tibble(
  plts = list(tab_res$p_up_bp[[2]] + labs(title = "Upregulated GO:BP Enrichment at 12-hpi"),
             tab_res$p_up_cc[[2]] + labs(title = "Upregulated GO:CC Enrichment at 12-hpi"),
             tab_res$p_up_mf[[2]] + labs(title = "Upregulated GO:MF Enrichment at 12-hpi"),
             tab_res$p_up_bp[[3]] + labs(title = "Upregulated GO:BP Enrichment at 24-hpi"),
             tab_res$p_up_cc[[3]] + labs(title = "Upregulated GO:CC Enrichment at 24-hpi"),
             tab_res$p_up_mf[[3]] + labs(title = "Upregulated GO:MF Enrichment at 24-hpi"),
             tab_res$p_down_bp[[2]] + labs(title = "Downregulated GO:BP Enrichment: 12-hpi"),
             tab_res$p_down_cc[[2]] + labs(title = "Downregulated GO:CC Enrichment: 12-hpi"),
             tab_res$p_down_mf[[2]] + labs(title = "Downregulated GO:MF Enrichment: 12-hpi"),
             tab_res$p_down_bp[[3]] + labs(title = "Downregulated GO:BP Enrichment: 24-hpi"),
             tab_res$p_down_cc[[3]] + labs(title = "Downregulated GO:CC Enrichment: 24-hpi"),
             tab_res$p_down_mf[[3]] + labs(title = "Downregulated GO:MF Enrichment: 24-hpi")),
