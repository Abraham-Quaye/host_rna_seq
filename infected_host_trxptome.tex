...
\urlstyle{same}
\hypersetup{
  pdftitle={Host Turkey B-cell Transcriptomics During THEV Infection Highlights Upregulated Cell Death and Breakdown Pathways and Other Biological Processes},
  hidelinks,
...
\begin{figure}
\centering
\includegraphics[width=1.1\linewidth,height=1.1\textheight]{results/r/figures/patch_GO_enrich.png}
