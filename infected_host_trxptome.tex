...
functionally enriched. GO enrichment analyses results at 12-hpi and
24-hpi showed significant similarities among all three GO categories. At
both 12 and 24-hpi, cellular breakdown processes were upregulated while
...
processing (\textbf{Figure 4A}). Under the cellular components (CP) GO
...
protein binding (\textbf{Table 2A}). For the downregulated DEGs, the GO
terms in BP category generally fall under: translation, protein
...
respirosome, and nucleus while the MF category GO terms belong to:
translation regulator activity and protein folding chaperone, catalytic
