...
24-hpi. Cell breakdown pathways such as: autophagy, response to
Influenza A, and steroid biosynthesis were upregulated at 12-hpi similar
to 24-hpi, where pathways such as: autophagy, ubiquitin-mediated
proteolysis, lysosome, protein processing in endoplasmic reticulum, and
steroid biosynthesis were upregulated. \newpage

\subsection{DISCUSSION}\label{discussion}

We may not have seen a measurable immune response/pathway in the
infected host cells because the these B-cells may likely require other
immune cells such as macrophages and T-cells for activation/mount an
immune response. \newpage
